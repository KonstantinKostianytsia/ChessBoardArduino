...
// LEDs constants
int BOARD_ROW_LED_PINS[8] = {4, 5, -1, -1, -1, -1, -1, -1};
#define NUM_LEDS_IN_ROW 8 // кількість діодів у рядку стрічці
#define LED_TYPE    WS2812B
#define COLOR_ORDER GRB
#define BRIGHTNESS 250

// FastLEDs variables
CRGB leds[8][NUM_LEDS_IN_ROW];
...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE, 4, COLOR_ORDER>(leds[0], NUM_LEDS_IN_ROW);
  FastLED.addLeds<LED_TYPE, 5, COLOR_ORDER>(leds[1], NUM_LEDS_IN_ROW);
  ...
  pCharacteristic->setCallbacks(new BLEOnWriteColorCallback());
